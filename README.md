...
> Self‑hosted, zero‑login bookmark vault – capture and find links in seconds.

---

## Overview

People need a simple, privacy‑first way to store and retrieve web links without creating accounts or trusting third‑party clouds.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/quickmark-lite
      branch: master
